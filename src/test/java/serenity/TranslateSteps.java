...
public class TranslateSteps {
    ...
    @Step
    public void selectLanguage(String language, String platform) throws Exception {
    ...
    @Step
    public void guidePageTranslate(String language, String platform, String deebotType) throws Exception {
        PageFactory.initElements(new AppiumFieldDecorator(appiumDriver, 10, SECONDS), DashboardPage.class);
    ...
    @Step
    public void cleanPageTranslate(String language, String platform, String deebotType) throws Exception {
        PageFactory.initElements(new AppiumFieldDecorator(appiumDriver, 10, SECONDS), DashboardPage.class);
        PageFactory.initElements(new AppiumFieldDecorator(appiumDriver, 10, SECONDS), CleanPage.class);
        if (platform.equals("ios")) {
            CommonPage.waitForVisible(appiumDriver, ("//XCUIElementTypeApplication[1]/XCUIElementTypeWindow[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther[2]/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeTable[1]/XCUIElementTypeCell[1]/XCUIElementTypeStaticText[2]"), 60, platform);
...
//            verifyTranslate(cleanPageStr2, excelList, "930 clean");
    ...
    @Step
    public void errorPageTranslate(String language, String platform, String deebotType) throws Exception {
        //get excel row content by column name
        ArrayList<String> excelList = getExcelRowItemByColumnName(language);
    ...
    @Step
    public void morePageTranslate(String language, String platform, String deebotType) throws Exception {
        //get excel row content by column name
        ArrayList<String> excelList = getExcelRowItemByColumnName(language);
        PageFactory.initElements(new AppiumFieldDecorator(appiumDriver, 10, SECONDS), CleanPage.class);
    ...
    private ArrayList<String> getExcelRowItemByColumnName(String language) throws Exception {
        InputStream inputStream = new FileInputStream("file/dr930Translation.xlsx");
...
//        Thread.sleep(5000);
        ...
        if (deebotType.equals("d700")) {
            ...
            String ipStr = morePage.ipAddressOnNetInfoPage.getText();
            String wifiStrengthValueStr = morePage.wifiStrengthValueOnNetInfoPage.getText();
            String wifiMapStr = morePage.wifiMapOnNetInfoPage.getText();
            verifyTranslate(title2Str, excelList, "network info");
            verifyTranslate(wifiNameStr, excelList, "network info");
            verifyTranslate(wifiStrengthStr, excelList, "network info");
            verifyTranslate(ipStr, excelList, "network info");
            verifyTranslate(wifiStrengthValueStr, excelList, "network info");
            verifyTranslate(wifiMapStr, excelList, "network info");
            //click into wifi map page and translate
            morePage.wifiMapOnNetInfoPage.click();
            Thread.sleep(2000);
            String wifiMapTitleStr = morePage.wifiMapTitle.getText();
            String wifimapPageLabel1Str = morePage.wifiMapLabel1.getText();
            String wifimapPageLabel2Str = morePage.wifiMapLabel2.getText();
            String wifimapPageLabel3Str = morePage.wifiMapLabel3.getText();
            String wifimapPageLabel4Str = morePage.wifiMapLabel4.getText();
            verifyTranslate(wifiMapTitleStr, excelList, "wifi map");
            verifyTranslate(wifimapPageLabel1Str, excelList, "wifi map");
            verifyTranslate(wifimapPageLabel2Str, excelList, "wifi map");
            verifyTranslate(wifimapPageLabel3Str, excelList, "wifi map");
            verifyTranslate(wifimapPageLabel4Str, excelList, "wifi map");
            morePage.backBtnOnWifiMapPage.click();
            Thread.sleep(2000);
            morePage.backBtnOnNetInfoPage.click();
            Thread.sleep(2000);
            morePage.backBtnOnDebootInfoPage.click();
    ...
    private void debootVoicePageTranslate(ArrayList<String> excelList, String platform, String deebotType) throws Exception {
        ...
        morePage.chooseLanguageOnDebootVoicePage.click();
        Thread.sleep(2000);
        String cancelStr1 = morePage.backBtnOnDebootVoicePage.getText();
        String titleStr1 = morePage.titleOnDebootVoicePage.getText();
        String saveStr1 = morePage.saveBtnOnDebootVoicePage.getText();
        verifyTranslate(cancelStr1, excelList, "choose voice");
        verifyTranslate(titleStr1, excelList, "choose voice");
        verifyTranslate(saveStr1, excelList, "choose voice");
...
//        Thread.sleep(6000);
    ...
    private void verifyTranslate(String appValue, ArrayList<String> list, String pageName) {
        boolean flag = false;
        for (String str : list) {
            if (str.replaceAll("\\pP", "").trim().replace(" ", "").replace("9", "").replace("<br>", "").replace("\r", "").replace("\n", "").replace("Integer", "").equals(appValue.replaceAll("\\pP", "").trim().replace(" ", "").replace("9", "").replace("\r", "").replace("\n", ""))) {
                System.out.println(" ");
        ...
        if (!flag) {
            System.err.println(" ");
            System.err.println("Translation on " + pageName + " page fail, test fail!");
            System.err.println("Translation on " + pageName + " page get error, test fail!" + "Actual value is:" + appValue.replaceAll("\\pP", "").trim().replace(" ", "").replace("\r", "").replace("\n", "") + "Expected value is:" + list.toString().replaceAll("\\pP", "").trim().replace(" ", "").replace("\r", "").replace("\n", "").replace("Integer", ""));
        }
    }
